    ...
    uint8_t enabled[4])
{
    ...
    /* Marshalling struct. */
    configure_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.enabled = (uint8_t*)enabled;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(configure_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(configure_args_t));
    if (enabled)
        OE_ADD_SIZE(_output_buffer_size, sizeof(uint8_t[4]));
    ...
    _pargs_in = (configure_args_t*)_input_buffer;
    ...
    _pargs_out = (configure_args_t*)_output_buffer;
    ...
    OE_READ_OUT_PARAM(enabled, (size_t)(sizeof(uint8_t[4])));
    ...
    size_t c)
{
    ...
    /* Marshalling struct. */
    aliasing_a_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(aliasing_a_args_t));
    if (d)
        OE_ADD_SIZE(_input_buffer_size, (_args.c * sizeof(char)));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(aliasing_a_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (aliasing_a_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (d)
        OE_WRITE_IN_PARAM(d, (_args.c * sizeof(char)), char*);
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (aliasing_a_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t* j)
{
    ...
    /* Marshalling struct. */
    aliasing_b_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(aliasing_b_args_t));
    if (g)
        OE_ADD_SIZE(_input_buffer_size, (_args.f * sizeof(size_t)));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(aliasing_b_args_t));
    if (h)
        OE_ADD_SIZE(_output_buffer_size, (_args.i * sizeof(char)));
    if (j)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (aliasing_b_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (g)
        OE_WRITE_IN_PARAM(g, (_args.f * sizeof(size_t)), size_t*);
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (aliasing_b_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->_retval;
    /* No pointers to restore for deep copy. */
    OE_READ_OUT_PARAM(h, (size_t)((_args.i * sizeof(char))));
    OE_READ_OUT_PARAM(j, (size_t)((1 * sizeof(size_t))));
    ...
    char a[2])
{
    ...
    /* Marshalling struct. */
    aliasing_c_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(aliasing_c_args_t));
    if (a)
        OE_ADD_SIZE(_input_buffer_size, sizeof(char[2]));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(aliasing_c_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (aliasing_c_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a)
        OE_WRITE_IN_PARAM(a, sizeof(char[2]), char*);
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (aliasing_c_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    char a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_char_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_char_args_t));
    if (a1)
        OE_ADD_SIZE(_input_buffer_size, sizeof(char[2]));
    if (a2)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_char_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_char_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_char_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    wchar_t a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_wchar_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_wchar_t_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_wchar_t_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_wchar_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_wchar_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_wchar_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    short int a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_short_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_short_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_short_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_short_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_short_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_int_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_int_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_int_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_int_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_int_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    float a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_float_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_float_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_float_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_float_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_float_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    double a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_double_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_double_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_double_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_double_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_double_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    long int a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_long_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_long_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_size_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_size_t_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_size_t_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_size_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_size_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned int a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_unsigned_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_unsigned_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_unsigned_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_unsigned_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_unsigned,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_unsigned_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int8_t a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_int8_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_int8_t_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_int8_t_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_int8_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_int8_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int16_t a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_int16_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_int16_t_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_int16_t_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_int16_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_int16_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_int16_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int32_t a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_int32_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_int32_t_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_int32_t_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_int32_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_int32_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_int32_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int64_t a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_int64_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_int64_t_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_int64_t_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_int64_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_int64_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_int64_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    uint8_t a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_uint8_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_uint8_t_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_uint8_t_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_uint8_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_uint8_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_uint8_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    uint16_t a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_uint16_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_uint16_t_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_uint16_t_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_uint16_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_uint16_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_uint16_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    uint32_t a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_uint32_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_uint32_t_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_uint32_t_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_uint32_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_uint32_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_uint32_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    uint64_t a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_uint64_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_uint64_t_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_uint64_t_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_uint64_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_uint64_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_uint64_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    long long a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_long_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_long_long_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_long_long_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_long_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_long_long,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_long_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    long double a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_long_double_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_long_double_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_long_double_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_long_double_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_long_double,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_long_double_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned char a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_unsigned_char_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_unsigned_char_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_unsigned_char_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_unsigned_char_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_unsigned_char,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_unsigned_char_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned short int a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_unsigned_short_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_unsigned_short_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_unsigned_short_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_unsigned_short_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_unsigned_short,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_unsigned_short_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned int a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_unsigned_int_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_unsigned_int_args_t));
    if (a1)
        OE_ADD_SIZE(_input_buffer_size, sizeof(unsigned int[2]));
    if (a2)
        OE_ADD_SIZE(_input_buffer_size, sizeof(unsigned int[2][2]));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_unsigned_int_args_t));
    if (a2)
        OE_ADD_SIZE(_output_buffer_size, sizeof(unsigned int[2][2]));
    if (a3)
        OE_ADD_SIZE(_output_buffer_size, sizeof(unsigned int[3][3]));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_unsigned_int_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
        OE_WRITE_IN_PARAM(a1, sizeof(unsigned int[2]), unsigned int*);
    if (a2)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_unsigned_int,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_unsigned_int_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned long int a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_unsigned_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_unsigned_long_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_unsigned_long_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_unsigned_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_unsigned_long,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_unsigned_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned long long a4[4][4])
{
    ...
    /* Marshalling struct. */
    ecall_array_unsigned_long_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_unsigned_long_long_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_unsigned_long_long_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_unsigned_long_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_unsigned_long_long,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_unsigned_long_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t test_array_edl_ocalls(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    test_array_edl_ocalls_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_array_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_array_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (test_array_edl_ocalls_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_test_array_edl_ocalls,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (test_array_edl_ocalls_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t ecall_array_assert_all_called(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    ecall_array_assert_all_called_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_array_assert_all_called_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_array_assert_all_called_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_array_assert_all_called_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_array_assert_all_called,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_array_assert_all_called_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned long long arg20)
{
    ...
    /* Marshalling struct. */
    ecall_basic_types_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_basic_types_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_basic_types_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_basic_types_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_basic_types_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    long double arg4)
{
    ...
    /* Marshalling struct. */
    ecall_basic_non_portable_types_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_basic_non_portable_types_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_basic_non_portable_types_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_basic_non_portable_types_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_basic_non_portable_types,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_basic_non_portable_types_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    type_enum_t t)
{
    ...
    /* Marshalling struct. */
    get_enclave_sizeof_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(get_enclave_sizeof_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(get_enclave_sizeof_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (get_enclave_sizeof_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (get_enclave_sizeof_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    char* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_char_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_char_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_char_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_char_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_char_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    wchar_t* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_wchar_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_wchar_t_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_wchar_t_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_wchar_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_wchar_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    short int* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_short_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_short_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_short_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_short_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_short_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_int_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_int_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_int_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_int_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_int_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    float* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_float_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_float_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_float_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_float_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_float_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    double* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_double_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_double_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_double_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_double_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_double_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    long int* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_long_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_long_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_size_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_size_t_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_size_t_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_size_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_size_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned int* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_unsigned_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_unsigned_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_unsigned_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_unsigned_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_unsigned_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int8_t* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_int8_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_int8_t_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_int8_t_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_int8_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_int8_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int16_t* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_int16_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_int16_t_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_int16_t_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_int16_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_int16_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int32_t* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_int32_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_int32_t_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_int32_t_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_int32_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_int32_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int64_t* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_int64_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_int64_t_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_int64_t_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_int64_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_int64_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    uint8_t* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_uint8_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_uint8_t_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_uint8_t_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_uint8_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_uint8_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    uint16_t* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_uint16_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_uint16_t_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_uint16_t_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_uint16_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_uint16_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    uint32_t* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_uint32_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_uint32_t_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_uint32_t_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_uint32_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_uint32_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    uint64_t* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_uint64_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_uint64_t_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_uint64_t_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_uint64_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_uint64_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    long long* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_long_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_long_long_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_long_long_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_long_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_ret_long_long,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_long_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned char* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_unsigned_char_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_unsigned_char_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_unsigned_char_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_unsigned_char_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_ret_unsigned_char,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_unsigned_char_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned short int* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_unsigned_short_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_unsigned_short_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_unsigned_short_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_unsigned_short_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_ret_unsigned_short,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_unsigned_short_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned int* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_unsigned_int_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_unsigned_int_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_unsigned_int_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_unsigned_int_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_ret_unsigned_int,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_unsigned_int_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned long int* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_unsigned_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_unsigned_long_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_unsigned_long_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_unsigned_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_ret_unsigned_long,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_unsigned_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    long double* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_long_double_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_long_double_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_long_double_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_long_double_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_ret_long_double,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_long_double_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned long long* _retval)
{
    ...
    /* Marshalling struct. */
    ecall_ret_unsigned_long_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_unsigned_long_long_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_unsigned_long_long_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_unsigned_long_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_ret_unsigned_long_long,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_unsigned_long_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t ecall_ret_void(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    ecall_ret_void_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_ret_void_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_ret_void_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_ret_void_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_ret_void_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t test_basic_edl_ocalls(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    test_basic_edl_ocalls_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_basic_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_basic_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (test_basic_edl_ocalls_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_test_basic_edl_ocalls,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (test_basic_edl_ocalls_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    uint64_t* ptr)
{
    ...
    /* Marshalling struct. */
    deepcopy_value_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    memset(&_args, 0, sizeof(_args));
    _args.s = s;
    _args.ptr = (uint64_t*)ptr;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_value_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_value_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_value_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_value_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    uint64_t* ptr)
{
    ...
    /* Marshalling struct. */
    deepcopy_shallow_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.s = (ShallowStruct*)s;
    _args.ptr = (uint64_t*)ptr;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_shallow_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (1 * sizeof(ShallowStruct)));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_shallow_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (1 * sizeof(ShallowStruct)));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_shallow_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (1 * sizeof(ShallowStruct)), ShallowStruct*);
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_shallow_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    /* No return value. */
    /* No pointers to restore for deep copy. */
    OE_READ_IN_OUT_PARAM(s, (size_t)((1 * sizeof(ShallowStruct))));
    ...
    CountStruct* s)
{
    ...
    /* Marshalling struct. */
    deepcopy_count_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    void** _ptrs = malloc(sizeof(void*) * (1));
    if (_ptrs == NULL)
    {
        _result = OE_OUT_OF_MEMORY;
        goto done;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.s = (CountStruct*)s;
    if (s)
        _ptrs[_ptrs_index++] = (void*)s->ptr;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_count_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (1 * sizeof(CountStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_input_buffer_size, (3 * sizeof(uint64_t)));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_count_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (1 * sizeof(CountStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_output_buffer_size, (3 * sizeof(uint64_t)));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_count_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (1 * sizeof(CountStruct)), CountStruct*);
    if (s && s->ptr)
        OE_WRITE_IN_OUT_PARAM(s->ptr, (3 * sizeof(uint64_t)), uint64_t*);
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_count_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    OE_READ_IN_OUT_PARAM(s, (size_t)((1 * sizeof(CountStruct))));
    if (s)
    {
        /* Restore original pointer. */
        s->ptr = (uint64_t*)_ptrs[_ptrs_index++];
        OE_READ_IN_OUT_PARAM(s->ptr, (size_t)((3 * sizeof(uint64_t))));
    }
    ...
    CountParamStruct* s)
{
    ...
    /* Marshalling struct. */
    deepcopy_countparam_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.s = (CountParamStruct*)s;
    if (s)
        _ptrs[_ptrs_index++] = (void*)s->ptr;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_countparam_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (1 * sizeof(CountParamStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_input_buffer_size, (_args.s->count * sizeof(uint64_t)));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_countparam_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (1 * sizeof(CountParamStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_output_buffer_size, (_args.s->count * sizeof(uint64_t)));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_countparam_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (1 * sizeof(CountParamStruct)), CountParamStruct*);
    if (s && s->ptr)
        OE_WRITE_IN_OUT_PARAM(s->ptr, (_args.s->count * sizeof(uint64_t)), uint64_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_deepcopy_countparam,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_countparam_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    /* No return value. */
    _ptrs_index = 0; /* For deep copy. */
    OE_READ_IN_OUT_PARAM(s, (size_t)((1 * sizeof(CountParamStruct))));
    if (s)
    {
        /* Restore original pointer. */
        s->ptr = (uint64_t*)_ptrs[_ptrs_index++];
        OE_READ_IN_OUT_PARAM(s->ptr, (size_t)((_args.s->count * sizeof(uint64_t))));
    }
    ...
    SizeParamStruct* s)
{
    ...
    /* Marshalling struct. */
    deepcopy_sizeparam_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.s = (SizeParamStruct*)s;
    if (s)
        _ptrs[_ptrs_index++] = (void*)s->ptr;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_sizeparam_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (1 * sizeof(SizeParamStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_input_buffer_size, _args.s->size);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_sizeparam_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (1 * sizeof(SizeParamStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_output_buffer_size, _args.s->size);
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_sizeparam_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (1 * sizeof(SizeParamStruct)), SizeParamStruct*);
    if (s && s->ptr)
        OE_WRITE_IN_OUT_PARAM(s->ptr, _args.s->size, uint64_t*);
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_sizeparam_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    /* No return value. */
    _ptrs_index = 0; /* For deep copy. */
    OE_READ_IN_OUT_PARAM(s, (size_t)((1 * sizeof(SizeParamStruct))));
    if (s)
    {
        /* Restore original pointer. */
        s->ptr = (uint64_t*)_ptrs[_ptrs_index++];
        OE_READ_IN_OUT_PARAM(s->ptr, (size_t)(_args.s->size));
    }
    ...
    CountSizeParamStruct* s)
{
    ...
    /* Marshalling struct. */
    deepcopy_countsizeparam_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.s = (CountSizeParamStruct*)s;
    if (s)
        _ptrs[_ptrs_index++] = (void*)s->ptr;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_countsizeparam_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (1 * sizeof(CountSizeParamStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_input_buffer_size, (_args.s->size * _args.s->count));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_countsizeparam_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (1 * sizeof(CountSizeParamStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_output_buffer_size, (_args.s->size * _args.s->count));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_countsizeparam_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (1 * sizeof(CountSizeParamStruct)), CountSizeParamStruct*);
    if (s && s->ptr)
        OE_WRITE_IN_OUT_PARAM(s->ptr, (_args.s->size * _args.s->count), uint64_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_deepcopy_countsizeparam,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_countsizeparam_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    /* No return value. */
    _ptrs_index = 0; /* For deep copy. */
    OE_READ_IN_OUT_PARAM(s, (size_t)((1 * sizeof(CountSizeParamStruct))));
    if (s)
    {
        /* Restore original pointer. */
        s->ptr = (uint64_t*)_ptrs[_ptrs_index++];
        OE_READ_IN_OUT_PARAM(s->ptr, (size_t)((_args.s->size * _args.s->count)));
    }
    ...
    CountSizeParamStruct* s)
{
    ...
    /* Marshalling struct. */
    deepcopy_countsizeparam_size_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_countsizeparam_size_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (1 * sizeof(CountSizeParamStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_input_buffer_size, (_args.s->size * _args.s->count));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_countsizeparam_size_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (1 * sizeof(CountSizeParamStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_output_buffer_size, (_args.s->size * _args.s->count));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_countsizeparam_size_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (1 * sizeof(CountSizeParamStruct)), CountSizeParamStruct*);
    if (s && s->ptr)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_deepcopy_countsizeparam_size,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_countsizeparam_size_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    CountSizeParamStruct* s)
{
    ...
    /* Marshalling struct. */
    deepcopy_countsizeparam_count_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_countsizeparam_count_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (1 * sizeof(CountSizeParamStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_input_buffer_size, (_args.s->size * _args.s->count));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_countsizeparam_count_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (1 * sizeof(CountSizeParamStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_output_buffer_size, (_args.s->size * _args.s->count));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_countsizeparam_count_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (1 * sizeof(CountSizeParamStruct)), CountSizeParamStruct*);
    if (s && s->ptr)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_deepcopy_countsizeparam_count,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_countsizeparam_count_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    CountParamStruct* s)
{
    ...
    /* Marshalling struct. */
    deepcopy_countparamarray_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Deep copy buffer. */
    size_t _ptrs_index = 0;
    void** _ptrs = malloc(sizeof(void*) * (2));
    if (_ptrs == NULL)
    {
        _result = OE_OUT_OF_MEMORY;
        goto done;
    ...
    {
        if (s)
            _ptrs[_ptrs_index++] = (void*)s[_i_1].ptr;
    }

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_countparamarray_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (2 * sizeof(CountParamStruct)));
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s && s[_i_1].ptr)
            OE_ADD_SIZE(_input_buffer_size, (_args.s[_i_1].count * sizeof(uint64_t)));
    }
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_countparamarray_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (2 * sizeof(CountParamStruct)));
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s && s[_i_1].ptr)
            OE_ADD_SIZE(_output_buffer_size, (_args.s[_i_1].count * sizeof(uint64_t)));
    }
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_countparamarray_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (2 * sizeof(CountParamStruct)), CountParamStruct*);
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s && s[_i_1].ptr)
            OE_WRITE_IN_OUT_PARAM(s[_i_1].ptr, (_args.s[_i_1].count * sizeof(uint64_t)), uint64_t*);
    }
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_deepcopy_countparamarray,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_countparamarray_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    /* No return value. */
    _ptrs_index = 0; /* For deep copy. */
    OE_READ_IN_OUT_PARAM(s, (size_t)((2 * sizeof(CountParamStruct))));
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s)
        {
            /* Restore original pointer. */
            s[_i_1].ptr = (uint64_t*)_ptrs[_ptrs_index++];
            OE_READ_IN_OUT_PARAM(s[_i_1].ptr, (size_t)((_args.s[_i_1].count * sizeof(uint64_t))));
        }
    }
    ...
    SizeParamStruct* s)
{
    ...
    /* Marshalling struct. */
    deepcopy_sizeparamarray_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_sizeparamarray_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (2 * sizeof(SizeParamStruct)));
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s && s[_i_1].ptr)
            OE_ADD_SIZE(_input_buffer_size, _args.s[_i_1].size);
    }
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_sizeparamarray_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (2 * sizeof(SizeParamStruct)));
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s && s[_i_1].ptr)
            OE_ADD_SIZE(_output_buffer_size, _args.s[_i_1].size);
    }
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_sizeparamarray_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (2 * sizeof(SizeParamStruct)), SizeParamStruct*);
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s && s[_i_1].ptr)
            OE_WRITE_IN_OUT_PARAM(s[_i_1].ptr, _args.s[_i_1].size, uint64_t*);
    }
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_deepcopy_sizeparamarray,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_sizeparamarray_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    /* No return value. */
    _ptrs_index = 0; /* For deep copy. */
    OE_READ_IN_OUT_PARAM(s, (size_t)((2 * sizeof(SizeParamStruct))));
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s)
        {
            /* Restore original pointer. */
            s[_i_1].ptr = (uint64_t*)_ptrs[_ptrs_index++];
            OE_READ_IN_OUT_PARAM(s[_i_1].ptr, (size_t)(_args.s[_i_1].size));
        }
    }
    ...
    CountSizeParamStruct* s)
{
    ...
    /* Marshalling struct. */
    deepcopy_countsizeparamarray_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_countsizeparamarray_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (2 * sizeof(CountSizeParamStruct)));
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s && s[_i_1].ptr)
            OE_ADD_SIZE(_input_buffer_size, (_args.s[_i_1].size * _args.s[_i_1].count));
    }
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_countsizeparamarray_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (2 * sizeof(CountSizeParamStruct)));
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s && s[_i_1].ptr)
            OE_ADD_SIZE(_output_buffer_size, (_args.s[_i_1].size * _args.s[_i_1].count));
    }
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_countsizeparamarray_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (2 * sizeof(CountSizeParamStruct)), CountSizeParamStruct*);
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s && s[_i_1].ptr)
            OE_WRITE_IN_OUT_PARAM(s[_i_1].ptr, (_args.s[_i_1].size * _args.s[_i_1].count), uint64_t*);
    }
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_deepcopy_countsizeparamarray,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_countsizeparamarray_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    /* No return value. */
    _ptrs_index = 0; /* For deep copy. */
    OE_READ_IN_OUT_PARAM(s, (size_t)((2 * sizeof(CountSizeParamStruct))));
    for (size_t _i_1 = 0; _i_1 < 2; _i_1++)
    {
        if (s)
        {
            /* Restore original pointer. */
            s[_i_1].ptr = (uint64_t*)_ptrs[_ptrs_index++];
            OE_READ_IN_OUT_PARAM(s[_i_1].ptr, (size_t)((_args.s[_i_1].size * _args.s[_i_1].count)));
        }
    }
    ...
    NestedStruct* n)
{
    ...
    /* Marshalling struct. */
    deepcopy_nested_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Deep copy buffer. */
    size_t _ptrs_index = 0;
    void** _ptrs = malloc(sizeof(void*) * (1 + 1 + 3));
    if (_ptrs == NULL)
    {
        _result = OE_OUT_OF_MEMORY;
        goto done;
    ...
    if (n)
        _ptrs[_ptrs_index++] = (void*)n->array_of_int;
    if (n)
        _ptrs[_ptrs_index++] = (void*)n->array_of_struct;
    for (size_t _i_2 = 0; _i_2 < 3; _i_2++)
    {
        if (n && n->array_of_struct)
            _ptrs[_ptrs_index++] = (void*)n->array_of_struct[_i_2].ptr;
    }

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_nested_args_t));
    if (n)
        OE_ADD_SIZE(_input_buffer_size, (1 * sizeof(NestedStruct)));
    if (n && n->array_of_int)
        OE_ADD_SIZE(_input_buffer_size, (4 * sizeof(int)));
    if (n && n->array_of_struct)
        OE_ADD_SIZE(_input_buffer_size, (3 * sizeof(CountStruct)));
    for (size_t _i_2 = 0; _i_2 < 3; _i_2++)
    {
        if (n && n->array_of_struct && n->array_of_struct[_i_2].ptr)
            OE_ADD_SIZE(_input_buffer_size, (3 * sizeof(uint64_t)));
    }
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_nested_args_t));
    if (n)
        OE_ADD_SIZE(_output_buffer_size, (1 * sizeof(NestedStruct)));
    if (n && n->array_of_int)
        OE_ADD_SIZE(_output_buffer_size, (4 * sizeof(int)));
    if (n && n->array_of_struct)
        OE_ADD_SIZE(_output_buffer_size, (3 * sizeof(CountStruct)));
    for (size_t _i_2 = 0; _i_2 < 3; _i_2++)
    {
        if (n && n->array_of_struct && n->array_of_struct[_i_2].ptr)
            OE_ADD_SIZE(_output_buffer_size, (3 * sizeof(uint64_t)));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_nested_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (n)
        OE_WRITE_IN_OUT_PARAM(n, (1 * sizeof(NestedStruct)), NestedStruct*);
    if (n && n->array_of_int)
        OE_WRITE_IN_OUT_PARAM(n->array_of_int, (4 * sizeof(int)), int*);
    if (n && n->array_of_struct)
        OE_WRITE_IN_OUT_PARAM(n->array_of_struct, (3 * sizeof(CountStruct)), CountStruct*);
    for (size_t _i_2 = 0; _i_2 < 3; _i_2++)
    {
        if (n && n->array_of_struct && n->array_of_struct[_i_2].ptr)
            OE_WRITE_IN_OUT_PARAM(n->array_of_struct[_i_2].ptr, (3 * sizeof(uint64_t)), uint64_t*);
    }
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_nested_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    /* No return value. */
    _ptrs_index = 0; /* For deep copy. */
    OE_READ_IN_OUT_PARAM(n, (size_t)((1 * sizeof(NestedStruct))));
    if (n)
    {
        /* Restore original pointer. */
        n->array_of_int = (int*)_ptrs[_ptrs_index++];
        OE_READ_IN_OUT_PARAM(n->array_of_int, (size_t)((4 * sizeof(int))));
    }
    if (n)
    {
        /* Restore original pointer. */
        n->array_of_struct = (CountStruct*)_ptrs[_ptrs_index++];
        OE_READ_IN_OUT_PARAM(n->array_of_struct, (size_t)((3 * sizeof(CountStruct))));
    }
    for (size_t _i_2 = 0; _i_2 < 3; _i_2++)
    {
        if (n && n->array_of_struct)
        {
            /* Restore original pointer. */
            n->array_of_struct[_i_2].ptr = (uint64_t*)_ptrs[_ptrs_index++];
            OE_READ_IN_OUT_PARAM(n->array_of_struct[_i_2].ptr, (size_t)((3 * sizeof(uint64_t))));
        }
    }
    ...
    size_t n)
{
    ...
    /* Marshalling struct. */
    deepcopy_super_nested_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Deep copy buffer. */
    size_t _ptrs_index = 0;
    void** _ptrs = malloc(sizeof(void*) * (n * (1 + 2 * (1 + 1 + 3))));
    if (_ptrs == NULL)
    {
        _result = OE_OUT_OF_MEMORY;
        goto done;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.s = (SuperNestedStruct*)s;
    _args.n = n;
    for (size_t _i_1 = 0; _i_1 < _args.n; _i_1++)
    {
        if (s)
            _ptrs[_ptrs_index++] = (void*)s[_i_1].more_structs;
        for (size_t _i_2 = 0; _i_2 < 2; _i_2++)
        {
            if (s && s[_i_1].more_structs)
                _ptrs[_ptrs_index++] = (void*)s[_i_1].more_structs[_i_2].array_of_int;
        }
        for (size_t _i_2 = 0; _i_2 < 2; _i_2++)
        {
            if (s && s[_i_1].more_structs)
                _ptrs[_ptrs_index++] = (void*)s[_i_1].more_structs[_i_2].array_of_struct;
            for (size_t _i_3 = 0; _i_3 < 3; _i_3++)
            {
                if (s && s[_i_1].more_structs && s[_i_1].more_structs[_i_2].array_of_struct)
                    _ptrs[_ptrs_index++] = (void*)s[_i_1].more_structs[_i_2].array_of_struct[_i_3].ptr;
            }
        }
    }

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_super_nested_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (_args.n * sizeof(SuperNestedStruct)));
    for (size_t _i_1 = 0; _i_1 < _args.n; _i_1++)
    {
        if (s && s[_i_1].more_structs)
            OE_ADD_SIZE(_input_buffer_size, (2 * sizeof(NestedStruct)));
        for (size_t _i_2 = 0; _i_2 < 2; _i_2++)
        {
            if (s && s[_i_1].more_structs && s[_i_1].more_structs[_i_2].array_of_int)
                OE_ADD_SIZE(_input_buffer_size, (4 * sizeof(int)));
        }
        for (size_t _i_2 = 0; _i_2 < 2; _i_2++)
        {
            ...
            for (size_t _i_3 = 0; _i_3 < 3; _i_3++)
            {
                if (s && s[_i_1].more_structs && s[_i_1].more_structs[_i_2].array_of_struct && s[_i_1].more_structs[_i_2].array_of_struct[_i_3].ptr)
                    OE_ADD_SIZE(_input_buffer_size, (3 * sizeof(uint64_t)));
            }
        }
    }
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_super_nested_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (_args.n * sizeof(SuperNestedStruct)));
    for (size_t _i_1 = 0; _i_1 < _args.n; _i_1++)
    {
        if (s && s[_i_1].more_structs)
            OE_ADD_SIZE(_output_buffer_size, (2 * sizeof(NestedStruct)));
        for (size_t _i_2 = 0; _i_2 < 2; _i_2++)
        {
            if (s && s[_i_1].more_structs && s[_i_1].more_structs[_i_2].array_of_int)
                OE_ADD_SIZE(_output_buffer_size, (4 * sizeof(int)));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_super_nested_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (_args.n * sizeof(SuperNestedStruct)), SuperNestedStruct*);
    for (size_t _i_1 = 0; _i_1 < _args.n; _i_1++)
    {
        if (s && s[_i_1].more_structs)
            OE_WRITE_IN_OUT_PARAM(s[_i_1].more_structs, (2 * sizeof(NestedStruct)), NestedStruct*);
        for (size_t _i_2 = 0; _i_2 < 2; _i_2++)
        {
            if (s && s[_i_1].more_structs && s[_i_1].more_structs[_i_2].array_of_int)
                OE_WRITE_IN_OUT_PARAM(s[_i_1].more_structs[_i_2].array_of_int, (4 * sizeof(int)), int*);
        }
        for (size_t _i_2 = 0; _i_2 < 2; _i_2++)
        {
            if (s && s[_i_1].more_structs && s[_i_1].more_structs[_i_2].array_of_struct)
                OE_WRITE_IN_OUT_PARAM(s[_i_1].more_structs[_i_2].array_of_struct, (3 * sizeof(CountStruct)), CountStruct*);
            for (size_t _i_3 = 0; _i_3 < 3; _i_3++)
            {
                if (s && s[_i_1].more_structs && s[_i_1].more_structs[_i_2].array_of_struct && s[_i_1].more_structs[_i_2].array_of_struct[_i_3].ptr)
                    OE_WRITE_IN_OUT_PARAM(s[_i_1].more_structs[_i_2].array_of_struct[_i_3].ptr, (3 * sizeof(uint64_t)), uint64_t*);
            }
        }
    }
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_deepcopy_super_nested,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_super_nested_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    /* No return value. */
    _ptrs_index = 0; /* For deep copy. */
    OE_READ_IN_OUT_PARAM(s, (size_t)((_args.n * sizeof(SuperNestedStruct))));
    for (size_t _i_1 = 0; _i_1 < _args.n; _i_1++)
    {
        if (s)
        {
            /* Restore original pointer. */
            s[_i_1].more_structs = (NestedStruct*)_ptrs[_ptrs_index++];
            OE_READ_IN_OUT_PARAM(s[_i_1].more_structs, (size_t)((2 * sizeof(NestedStruct))));
        }
        for (size_t _i_2 = 0; _i_2 < 2; _i_2++)
        {
            if (s && s[_i_1].more_structs)
            {
                /* Restore original pointer. */
                s[_i_1].more_structs[_i_2].array_of_int = (int*)_ptrs[_ptrs_index++];
                OE_READ_IN_OUT_PARAM(s[_i_1].more_structs[_i_2].array_of_int, (size_t)((4 * sizeof(int))));
            }
        }
        for (size_t _i_2 = 0; _i_2 < 2; _i_2++)
        {
            ...
            {
                /* Restore original pointer. */
                s[_i_1].more_structs[_i_2].array_of_struct = (CountStruct*)_ptrs[_ptrs_index++];
                OE_READ_IN_OUT_PARAM(s[_i_1].more_structs[_i_2].array_of_struct, (size_t)((3 * sizeof(CountStruct))));
            }
            for (size_t _i_3 = 0; _i_3 < 3; _i_3++)
            {
                if (s && s[_i_1].more_structs && s[_i_1].more_structs[_i_2].array_of_struct)
                {
                    /* Restore original pointer. */
                    s[_i_1].more_structs[_i_2].array_of_struct[_i_3].ptr = (uint64_t*)_ptrs[_ptrs_index++];
                    OE_READ_IN_OUT_PARAM(s[_i_1].more_structs[_i_2].array_of_struct[_i_3].ptr, (size_t)((3 * sizeof(uint64_t))));
                }
            }
        }
    }
    ...
    CountStruct* s)
{
    ...
    /* Marshalling struct. */
    deepcopy_null_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_null_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (1 * sizeof(CountStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_input_buffer_size, (3 * sizeof(uint64_t)));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_null_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (1 * sizeof(CountStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_output_buffer_size, (3 * sizeof(uint64_t)));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_null_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (1 * sizeof(CountStruct)), CountStruct*);
    if (s && s->ptr)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_null_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    CountStruct* s)
{
    ...
    /* Marshalling struct. */
    deepcopy_out_count_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_out_count_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, (1 * sizeof(CountStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_input_buffer_size, (3 * sizeof(uint64_t)));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_out_count_args_t));
    if (s)
        OE_ADD_SIZE(_output_buffer_size, (1 * sizeof(CountStruct)));
    if (s && s->ptr)
        OE_ADD_SIZE(_output_buffer_size, (3 * sizeof(uint64_t)));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_out_count_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_OUT_PARAM(s, (1 * sizeof(CountStruct)), CountStruct*);
    if (s && s->ptr)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_out_count_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t n)
{
    ...
    /* Marshalling struct. */
    deepcopy_iovec_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Deep copy buffer. */
    size_t _ptrs_index = 0;
    void** _ptrs = malloc(sizeof(void*) * (n));
    if (_ptrs == NULL)
    {
        _result = OE_OUT_OF_MEMORY;
        goto done;
    ...
    {
        if (iov)
            _ptrs[_ptrs_index++] = (void*)iov[_i_1].base;
    }

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(deepcopy_iovec_args_t));
    if (iov)
        OE_ADD_SIZE(_input_buffer_size, (_args.n * sizeof(IOVEC)));
    for (size_t _i_1 = 0; _i_1 < _args.n; _i_1++)
    {
        if (iov && iov[_i_1].base)
            OE_ADD_SIZE(_input_buffer_size, _args.iov[_i_1].len);
    }
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(deepcopy_iovec_args_t));
    if (iov)
        OE_ADD_SIZE(_output_buffer_size, (_args.n * sizeof(IOVEC)));
    for (size_t _i_1 = 0; _i_1 < _args.n; _i_1++)
    {
        if (iov && iov[_i_1].base)
            OE_ADD_SIZE(_output_buffer_size, _args.iov[_i_1].len);
    }
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (deepcopy_iovec_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (iov)
        OE_WRITE_IN_OUT_PARAM(iov, (_args.n * sizeof(IOVEC)), IOVEC*);
    for (size_t _i_1 = 0; _i_1 < _args.n; _i_1++)
    {
        if (iov && iov[_i_1].base)
            OE_WRITE_IN_OUT_PARAM(iov[_i_1].base, _args.iov[_i_1].len, void*);
    }
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (deepcopy_iovec_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    /* No return value. */
    _ptrs_index = 0; /* For deep copy. */
    OE_READ_IN_OUT_PARAM(iov, (size_t)((_args.n * sizeof(IOVEC))));
    for (size_t _i_1 = 0; _i_1 < _args.n; _i_1++)
    {
        if (iov)
        {
            /* Restore original pointer. */
            iov[_i_1].base = (void*)_ptrs[_ptrs_index++];
            OE_READ_IN_OUT_PARAM(iov[_i_1].base, (size_t)(_args.iov[_i_1].len));
        }
    }
    ...
    size_t size)
{
    ...
    /* Marshalling struct. */
    ecall_enum1_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_enum1_args_t));
    if (a2)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_enum1_args_t));
    if (a3)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_enum1_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a2)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_enum1_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t test_enum_edl_ocalls(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    test_enum_edl_ocalls_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_enum_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_enum_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (test_enum_edl_ocalls_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_test_enum_edl_ocalls,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (test_enum_edl_ocalls_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t test_errno_edl_ocalls(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    test_errno_edl_ocalls_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_errno_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_errno_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (test_errno_edl_ocalls_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_test_errno_edl_ocalls,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (test_errno_edl_ocalls_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    my_type1* a3)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_ptr_1_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_ptr_1_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_ptr_1_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_ptr_1_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_ptr_1,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_ptr_1_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    my_type1* a3)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_ptr_2_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_ptr_2_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_ptr_2_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_ptr_2_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_ptr_2,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_ptr_2_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    my_type1* a3)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_ptr_3_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_ptr_3_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_ptr_3_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_ptr_3_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_ptr_3,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_ptr_3_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t count)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_ptr_4_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_ptr_4_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_ptr_4_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_ptr_4_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_ptr_4,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_ptr_4_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t size)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_ptr_5_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_ptr_5_args_t));
    if (a1)
        OE_ADD_SIZE(_input_buffer_size, _args.size);
    if (a2)
        OE_ADD_SIZE(_input_buffer_size, _args.size);
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_ptr_5_args_t));
    if (a2)
        OE_ADD_SIZE(_output_buffer_size, _args.size);
    if (a3)
        OE_ADD_SIZE(_output_buffer_size, _args.size);
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_ptr_5_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_ptr_5,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_ptr_5_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    my_type2 a3)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_isptr_1_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_isptr_1_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_isptr_1_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_isptr_1_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_isptr_1,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_isptr_1_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    my_type2 a3)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_isptr_2_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_isptr_2_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_isptr_2_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_isptr_2_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_isptr_2,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_isptr_2_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    my_type2 a3)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_isptr_3_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_isptr_3_args_t));
    if (a1)
        OE_ADD_SIZE(_input_buffer_size, 64);
    if (a2)
        OE_ADD_SIZE(_input_buffer_size, 64);
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_isptr_3_args_t));
    if (a2)
        OE_ADD_SIZE(_output_buffer_size, 64);
    if (a3)
        OE_ADD_SIZE(_output_buffer_size, 64);
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_isptr_3_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_isptr_3,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_isptr_3_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t count)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_isptr_4_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_isptr_4_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_isptr_4_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_isptr_4_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_isptr_4,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_isptr_4_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t size)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_isptr_5_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_isptr_5_args_t));
    if (a1)
        OE_ADD_SIZE(_input_buffer_size, _args.size);
    if (a2)
        OE_ADD_SIZE(_input_buffer_size, _args.size);
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_isptr_5_args_t));
    if (a2)
        OE_ADD_SIZE(_output_buffer_size, _args.size);
    if (a3)
        OE_ADD_SIZE(_output_buffer_size, _args.size);
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_isptr_5_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_isptr_5,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_isptr_5_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    my_type3 a3)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_isary_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_isary_args_t));
    if (a1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_isary_args_t));
    if (a2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_isary_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_isary,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_isary_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    my_type1 a1)
{
    ...
    /* Marshalling struct. */
    ecall_foreign_value_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_foreign_value_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_foreign_value_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_foreign_value_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_foreign_value,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_foreign_value_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t test_foreign_edl_ocalls(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    test_foreign_edl_ocalls_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_foreign_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_foreign_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (test_foreign_edl_ocalls_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_test_foreign_edl_ocalls,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (test_foreign_edl_ocalls_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_char_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_char_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_char_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_char_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_char_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_wchar_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_wchar_t_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_wchar_t_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_wchar_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_wchar_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_wchar_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_short_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_short_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_short_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_short_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_short,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_short_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_int_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_int_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_int_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_int_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_int_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_float_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_float_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_float_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_float_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_float,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_float_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_double_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_double_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_double_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_double_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_double,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_double_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_long_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_long_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_size_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_size_t_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_size_t_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_size_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_size_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_size_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_unsigned_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_unsigned_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_unsigned_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_unsigned_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_unsigned,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_unsigned_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_int8_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_int8_t_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_int8_t_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_int8_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_int8_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_int8_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_int16_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_int16_t_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_int16_t_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_int16_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_int16_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_int16_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_int32_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_int32_t_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_int32_t_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_int32_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_int32_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_int32_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_int64_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_int64_t_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_int64_t_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_int64_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_int64_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_int64_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_uint8_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_uint8_t_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_uint8_t_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_uint8_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_uint8_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_uint8_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_uint16_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_uint16_t_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_uint16_t_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_uint16_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_uint16_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_uint16_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_uint32_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_uint32_t_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_uint32_t_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_uint32_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_uint32_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_uint32_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_uint64_t_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_uint64_t_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_uint64_t_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_uint64_t_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_uint64_t,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_uint64_t_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_long_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_long_long_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_long_long_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_long_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_long_long,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_long_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_unsigned_char_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_unsigned_char_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_unsigned_char_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_unsigned_char_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_unsigned_char,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_unsigned_char_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_unsigned_short_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_unsigned_short_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_unsigned_short_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_unsigned_short_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_unsigned_short,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_unsigned_short_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_unsigned_int_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_unsigned_int_args_t));
    if (p1)
        OE_ADD_SIZE(_input_buffer_size, sizeof(unsigned int));
    if (p2)
        OE_ADD_SIZE(_input_buffer_size, sizeof(unsigned int));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_unsigned_int_args_t));
    if (p2)
        OE_ADD_SIZE(_output_buffer_size, sizeof(unsigned int));
    if (p3)
        OE_ADD_SIZE(_output_buffer_size, sizeof(unsigned int));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_unsigned_int_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
        OE_WRITE_IN_PARAM(p1, sizeof(unsigned int), unsigned int*);
    if (p2)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_unsigned_int,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_unsigned_int_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_unsigned_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_unsigned_long_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_unsigned_long_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_unsigned_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_unsigned_long,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_unsigned_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_unsigned_long_long_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_unsigned_long_long_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_unsigned_long_long_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_unsigned_long_long_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_unsigned_long_long,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_unsigned_long_long_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int psize)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_long_double_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_long_double_args_t));
    if (p1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_long_double_args_t));
    if (p2)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_long_double_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (p1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_long_double,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_long_double_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned long long unsigned_long_long_count)
{
    ...
    /* Marshalling struct. */
    ecall_count_attribute_all_types_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_count_attribute_all_types_args_t));
    if (b1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_count_attribute_all_types_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_count_attribute_all_types_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (b1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_count_attribute_all_types,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_count_attribute_all_types_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    unsigned long long unsigned_long_long_size)
{
    ...
    /* Marshalling struct. */
    ecall_size_attribute_all_types_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_size_attribute_all_types_args_t));
    if (b1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_size_attribute_all_types_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_size_attribute_all_types_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (b1)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_size_attribute_all_types,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_size_attribute_all_types_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t test_pointer_edl_ocalls(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    test_pointer_edl_ocalls_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_pointer_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_pointer_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (test_pointer_edl_ocalls_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_test_pointer_edl_ocalls,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (test_pointer_edl_ocalls_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t ecall_pointer_assert_all_called(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    ecall_pointer_assert_all_called_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_pointer_assert_all_called_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_pointer_assert_all_called_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_pointer_assert_all_called_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_ecall_pointer_assert_all_called,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_pointer_assert_all_called_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    char* s)
{
    ...
    /* Marshalling struct. */
    ecall_string_fun1_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_string_fun1_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, _args.s_len * sizeof(char));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_string_fun1_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_string_fun1_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_string_fun1_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    const char* s)
{
    ...
    /* Marshalling struct. */
    ecall_string_fun2_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_string_fun2_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, _args.s_len * sizeof(char));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_string_fun2_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_string_fun2_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_PARAM(s, _args.s_len * sizeof(char), char*);
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_string_fun2_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    char* s)
{
    ...
    /* Marshalling struct. */
    ecall_string_fun3_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_string_fun3_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, _args.s_len * sizeof(char));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_string_fun3_args_t));
    if (s)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_string_fun3_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_string_fun3_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    char* s)
{
    ...
    /* Marshalling struct. */
    ecall_string_fun5_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_string_fun5_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_string_fun5_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_string_fun5_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_string_fun5_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    const char* s)
{
    ...
    /* Marshalling struct. */
    ecall_string_fun6_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_string_fun6_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_string_fun6_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_string_fun6_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_string_fun6_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    char* s2)
{
    ...
    /* Marshalling struct. */
    ecall_string_fun7_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_string_fun7_args_t));
    if (s1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_string_fun7_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_string_fun7_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_string_fun7_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t test_string_edl_ocalls(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    test_string_edl_ocalls_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_string_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_string_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (test_string_edl_ocalls_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_test_string_edl_ocalls,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (test_string_edl_ocalls_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    wchar_t* s)
{
    ...
    /* Marshalling struct. */
    ecall_wstring_fun1_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_wstring_fun1_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, _args.s_len * sizeof(wchar_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_wstring_fun1_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_wstring_fun1_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_wstring_fun1_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    const wchar_t* s)
{
    ...
    /* Marshalling struct. */
    ecall_wstring_fun2_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_wstring_fun2_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, _args.s_len * sizeof(wchar_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_wstring_fun2_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_wstring_fun2_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
        OE_WRITE_IN_PARAM(s, _args.s_len * sizeof(wchar_t), wchar_t*);
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_wstring_fun2_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    wchar_t* s)
{
    ...
    /* Marshalling struct. */
    ecall_wstring_fun3_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_wstring_fun3_args_t));
    if (s)
        OE_ADD_SIZE(_input_buffer_size, _args.s_len * sizeof(wchar_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_wstring_fun3_args_t));
    if (s)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_wstring_fun3_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_wstring_fun3_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    wchar_t* s)
{
    ...
    /* Marshalling struct. */
    ecall_wstring_fun5_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_wstring_fun5_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_wstring_fun5_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_wstring_fun5_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_wstring_fun5_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    const wchar_t* s)
{
    ...
    /* Marshalling struct. */
    ecall_wstring_fun6_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_wstring_fun6_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_wstring_fun6_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_wstring_fun6_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_wstring_fun6_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    wchar_t* s2)
{
    ...
    /* Marshalling struct. */
    ecall_wstring_fun7_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_wstring_fun7_args_t));
    if (s1)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_wstring_fun7_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_wstring_fun7_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (s1)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_wstring_fun7_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t test_wstring_edl_ocalls(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    test_wstring_edl_ocalls_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_wstring_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_wstring_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (test_wstring_edl_ocalls_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_test_wstring_edl_ocalls,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (test_wstring_edl_ocalls_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    char* s2)
{
    ...
    /* Marshalling struct. */
    ecall_string_no_null_terminator_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_string_no_null_terminator_args_t));
    if (s1)
        OE_ADD_SIZE(_input_buffer_size, _args.s1_len * sizeof(char));
    if (s2)
        OE_ADD_SIZE(_input_buffer_size, _args.s2_len * sizeof(char));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_string_no_null_terminator_args_t));
    if (s2)
    ...
    /* No return value. */
    /* No pointers to restore for deep copy. */
    OE_CHECK_NULL_TERMINATOR(_output_buffer + _output_buffer_offset, _args.s2_len);
    ...
    wchar_t* s2)
{
    ...
    /* Marshalling struct. */
    ecall_wstring_no_null_terminator_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_wstring_no_null_terminator_args_t));
    if (s1)
        OE_ADD_SIZE(_input_buffer_size, _args.s1_len * sizeof(wchar_t));
    if (s2)
        OE_ADD_SIZE(_input_buffer_size, _args.s2_len * sizeof(wchar_t));
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_wstring_no_null_terminator_args_t));
    if (s2)
    ...
    /* No return value. */
    /* No pointers to restore for deep copy. */
    OE_CHECK_NULL_TERMINATOR_WIDE(_output_buffer + _output_buffer_offset, _args.s2_len);
    ...
    size_t size)
{
    ...
    /* Marshalling struct. */
    ecall_struct1_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_struct1_args_t));
    if (a2)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_struct1_args_t));
    if (a3)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_struct1_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (a2)
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_struct1_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t test_struct_edl_ocalls(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    test_struct_edl_ocalls_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_struct_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_struct_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (test_struct_edl_ocalls_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_test_struct_edl_ocalls,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (test_struct_edl_ocalls_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int b)
{
    ...
    /* Marshalling struct. */
    ecall_sum_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_sum_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_sum_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_sum_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_sum_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    int b)
{
    ...
    /* Marshalling struct. */
    switchless_ecall_sum_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(switchless_ecall_sum_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(switchless_ecall_sum_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (switchless_ecall_sum_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_switchless_call_enclave_function(
             enclave,
             all_fcn_id_switchless_ecall_sum,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (switchless_ecall_sum_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t test_switchless_edl_ocalls(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    test_switchless_edl_ocalls_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_switchless_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_switchless_edl_ocalls_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (test_switchless_edl_ocalls_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             all_fcn_id_test_switchless_edl_ocalls,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (test_switchless_edl_ocalls_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
oe_result_t enc_foo1(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    enc_foo1_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(enc_foo1_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enc_foo1_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (enc_foo1_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (enc_foo1_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_char_args_t* pargs_in = (ocall_array_char_args_t*)input_buffer;
    ocall_array_char_args_t* pargs_out = (ocall_array_char_args_t*)output_buffer;
...
void ocall_ocall_array_wchar_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_wchar_t_args_t* pargs_in = (ocall_array_wchar_t_args_t*)input_buffer;
    ocall_array_wchar_t_args_t* pargs_out = (ocall_array_wchar_t_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_short_args_t* pargs_in = (ocall_array_short_args_t*)input_buffer;
    ocall_array_short_args_t* pargs_out = (ocall_array_short_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_int_args_t* pargs_in = (ocall_array_int_args_t*)input_buffer;
    ocall_array_int_args_t* pargs_out = (ocall_array_int_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_float_args_t* pargs_in = (ocall_array_float_args_t*)input_buffer;
    ocall_array_float_args_t* pargs_out = (ocall_array_float_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_double_args_t* pargs_in = (ocall_array_double_args_t*)input_buffer;
    ocall_array_double_args_t* pargs_out = (ocall_array_double_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_long_args_t* pargs_in = (ocall_array_long_args_t*)input_buffer;
    ocall_array_long_args_t* pargs_out = (ocall_array_long_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_size_t_args_t* pargs_in = (ocall_array_size_t_args_t*)input_buffer;
    ocall_array_size_t_args_t* pargs_out = (ocall_array_size_t_args_t*)output_buffer;
...
void ocall_ocall_array_unsigned(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_unsigned_args_t* pargs_in = (ocall_array_unsigned_args_t*)input_buffer;
    ocall_array_unsigned_args_t* pargs_out = (ocall_array_unsigned_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_int8_t_args_t* pargs_in = (ocall_array_int8_t_args_t*)input_buffer;
    ocall_array_int8_t_args_t* pargs_out = (ocall_array_int8_t_args_t*)output_buffer;
...
void ocall_ocall_array_int16_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_int16_t_args_t* pargs_in = (ocall_array_int16_t_args_t*)input_buffer;
    ocall_array_int16_t_args_t* pargs_out = (ocall_array_int16_t_args_t*)output_buffer;
...
void ocall_ocall_array_int32_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_int32_t_args_t* pargs_in = (ocall_array_int32_t_args_t*)input_buffer;
    ocall_array_int32_t_args_t* pargs_out = (ocall_array_int32_t_args_t*)output_buffer;
...
void ocall_ocall_array_int64_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_int64_t_args_t* pargs_in = (ocall_array_int64_t_args_t*)input_buffer;
    ocall_array_int64_t_args_t* pargs_out = (ocall_array_int64_t_args_t*)output_buffer;
...
void ocall_ocall_array_uint8_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_uint8_t_args_t* pargs_in = (ocall_array_uint8_t_args_t*)input_buffer;
    ocall_array_uint8_t_args_t* pargs_out = (ocall_array_uint8_t_args_t*)output_buffer;
...
void ocall_ocall_array_uint16_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_uint16_t_args_t* pargs_in = (ocall_array_uint16_t_args_t*)input_buffer;
    ocall_array_uint16_t_args_t* pargs_out = (ocall_array_uint16_t_args_t*)output_buffer;
...
void ocall_ocall_array_uint32_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_uint32_t_args_t* pargs_in = (ocall_array_uint32_t_args_t*)input_buffer;
    ocall_array_uint32_t_args_t* pargs_out = (ocall_array_uint32_t_args_t*)output_buffer;
...
void ocall_ocall_array_uint64_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_uint64_t_args_t* pargs_in = (ocall_array_uint64_t_args_t*)input_buffer;
    ocall_array_uint64_t_args_t* pargs_out = (ocall_array_uint64_t_args_t*)output_buffer;
...
void ocall_ocall_array_long_long(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_long_long_args_t* pargs_in = (ocall_array_long_long_args_t*)input_buffer;
    ocall_array_long_long_args_t* pargs_out = (ocall_array_long_long_args_t*)output_buffer;
...
void ocall_ocall_array_unsigned_char(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_unsigned_char_args_t* pargs_in = (ocall_array_unsigned_char_args_t*)input_buffer;
    ocall_array_unsigned_char_args_t* pargs_out = (ocall_array_unsigned_char_args_t*)output_buffer;
...
void ocall_ocall_array_unsigned_short(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_unsigned_short_args_t* pargs_in = (ocall_array_unsigned_short_args_t*)input_buffer;
    ocall_array_unsigned_short_args_t* pargs_out = (ocall_array_unsigned_short_args_t*)output_buffer;
...
void ocall_ocall_array_unsigned_int(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_unsigned_int_args_t* pargs_in = (ocall_array_unsigned_int_args_t*)input_buffer;
    ocall_array_unsigned_int_args_t* pargs_out = (ocall_array_unsigned_int_args_t*)output_buffer;
...
void ocall_ocall_array_unsigned_long(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_unsigned_long_args_t* pargs_in = (ocall_array_unsigned_long_args_t*)input_buffer;
    ocall_array_unsigned_long_args_t* pargs_out = (ocall_array_unsigned_long_args_t*)output_buffer;
...
void ocall_ocall_array_unsigned_long_long(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_unsigned_long_long_args_t* pargs_in = (ocall_array_unsigned_long_long_args_t*)input_buffer;
    ocall_array_unsigned_long_long_args_t* pargs_out = (ocall_array_unsigned_long_long_args_t*)output_buffer;
    ...
    /* Call user function. */
    ocall_array_unsigned_long_long(
...
void ocall_ocall_array_long_double(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_long_double_args_t* pargs_in = (ocall_array_long_double_args_t*)input_buffer;
    ocall_array_long_double_args_t* pargs_out = (ocall_array_long_double_args_t*)output_buffer;
...
void ocall_ocall_array_assert_all_called(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_array_assert_all_called_args_t* pargs_in = (ocall_array_assert_all_called_args_t*)input_buffer;
    ocall_array_assert_all_called_args_t* pargs_out = (ocall_array_assert_all_called_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_basic_types_args_t* pargs_in = (ocall_basic_types_args_t*)input_buffer;
    ocall_basic_types_args_t* pargs_out = (ocall_basic_types_args_t*)output_buffer;
...
void ocall_ocall_basic_non_portable_types(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_basic_non_portable_types_args_t* pargs_in = (ocall_basic_non_portable_types_args_t*)input_buffer;
    ocall_basic_non_portable_types_args_t* pargs_out = (ocall_basic_non_portable_types_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    get_host_sizeof_args_t* pargs_in = (get_host_sizeof_args_t*)input_buffer;
    get_host_sizeof_args_t* pargs_out = (get_host_sizeof_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = get_host_sizeof(
        pargs_in->t);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_char_args_t* pargs_in = (ocall_ret_char_args_t*)input_buffer;
    ocall_ret_char_args_t* pargs_out = (ocall_ret_char_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_char(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_wchar_t_args_t* pargs_in = (ocall_ret_wchar_t_args_t*)input_buffer;
    ocall_ret_wchar_t_args_t* pargs_out = (ocall_ret_wchar_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_wchar_t(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_short_args_t* pargs_in = (ocall_ret_short_args_t*)input_buffer;
    ocall_ret_short_args_t* pargs_out = (ocall_ret_short_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_short(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_int_args_t* pargs_in = (ocall_ret_int_args_t*)input_buffer;
    ocall_ret_int_args_t* pargs_out = (ocall_ret_int_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_int(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_float_args_t* pargs_in = (ocall_ret_float_args_t*)input_buffer;
    ocall_ret_float_args_t* pargs_out = (ocall_ret_float_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_float(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_double_args_t* pargs_in = (ocall_ret_double_args_t*)input_buffer;
    ocall_ret_double_args_t* pargs_out = (ocall_ret_double_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_double(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_long_args_t* pargs_in = (ocall_ret_long_args_t*)input_buffer;
    ocall_ret_long_args_t* pargs_out = (ocall_ret_long_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_long(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_size_t_args_t* pargs_in = (ocall_ret_size_t_args_t*)input_buffer;
    ocall_ret_size_t_args_t* pargs_out = (ocall_ret_size_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_size_t(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_unsigned_args_t* pargs_in = (ocall_ret_unsigned_args_t*)input_buffer;
    ocall_ret_unsigned_args_t* pargs_out = (ocall_ret_unsigned_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_unsigned(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_int8_t_args_t* pargs_in = (ocall_ret_int8_t_args_t*)input_buffer;
    ocall_ret_int8_t_args_t* pargs_out = (ocall_ret_int8_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_int8_t(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_int16_t_args_t* pargs_in = (ocall_ret_int16_t_args_t*)input_buffer;
    ocall_ret_int16_t_args_t* pargs_out = (ocall_ret_int16_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_int16_t(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_int32_t_args_t* pargs_in = (ocall_ret_int32_t_args_t*)input_buffer;
    ocall_ret_int32_t_args_t* pargs_out = (ocall_ret_int32_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_int32_t(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_int64_t_args_t* pargs_in = (ocall_ret_int64_t_args_t*)input_buffer;
    ocall_ret_int64_t_args_t* pargs_out = (ocall_ret_int64_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_int64_t(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_uint8_t_args_t* pargs_in = (ocall_ret_uint8_t_args_t*)input_buffer;
    ocall_ret_uint8_t_args_t* pargs_out = (ocall_ret_uint8_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_uint8_t(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_uint16_t_args_t* pargs_in = (ocall_ret_uint16_t_args_t*)input_buffer;
    ocall_ret_uint16_t_args_t* pargs_out = (ocall_ret_uint16_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_uint16_t(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_uint32_t_args_t* pargs_in = (ocall_ret_uint32_t_args_t*)input_buffer;
    ocall_ret_uint32_t_args_t* pargs_out = (ocall_ret_uint32_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_uint32_t(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_uint64_t_args_t* pargs_in = (ocall_ret_uint64_t_args_t*)input_buffer;
    ocall_ret_uint64_t_args_t* pargs_out = (ocall_ret_uint64_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_uint64_t(
    );
...
void ocall_ocall_ret_long_long(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_long_long_args_t* pargs_in = (ocall_ret_long_long_args_t*)input_buffer;
    ocall_ret_long_long_args_t* pargs_out = (ocall_ret_long_long_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_long_long(
    );
...
void ocall_ocall_ret_unsigned_char(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_unsigned_char_args_t* pargs_in = (ocall_ret_unsigned_char_args_t*)input_buffer;
    ocall_ret_unsigned_char_args_t* pargs_out = (ocall_ret_unsigned_char_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_unsigned_char(
    );
...
void ocall_ocall_ret_unsigned_short(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_unsigned_short_args_t* pargs_in = (ocall_ret_unsigned_short_args_t*)input_buffer;
    ocall_ret_unsigned_short_args_t* pargs_out = (ocall_ret_unsigned_short_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_unsigned_short(
    );
...
void ocall_ocall_ret_unsigned_int(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_unsigned_int_args_t* pargs_in = (ocall_ret_unsigned_int_args_t*)input_buffer;
    ocall_ret_unsigned_int_args_t* pargs_out = (ocall_ret_unsigned_int_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_unsigned_int(
    );
...
void ocall_ocall_ret_unsigned_long(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_unsigned_long_args_t* pargs_in = (ocall_ret_unsigned_long_args_t*)input_buffer;
    ocall_ret_unsigned_long_args_t* pargs_out = (ocall_ret_unsigned_long_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_unsigned_long(
    );
...
void ocall_ocall_ret_long_double(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_long_double_args_t* pargs_in = (ocall_ret_long_double_args_t*)input_buffer;
    ocall_ret_long_double_args_t* pargs_out = (ocall_ret_long_double_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_long_double(
    );
...
void ocall_ocall_ret_unsigned_long_long(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_unsigned_long_long_args_t* pargs_in = (ocall_ret_unsigned_long_long_args_t*)input_buffer;
    ocall_ret_unsigned_long_long_args_t* pargs_out = (ocall_ret_unsigned_long_long_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_ret_unsigned_long_long(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_ret_void_args_t* pargs_in = (ocall_ret_void_args_t*)input_buffer;
    ocall_ret_void_args_t* pargs_out = (ocall_ret_void_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_enum1_args_t* pargs_in = (ocall_enum1_args_t*)input_buffer;
    ocall_enum1_args_t* pargs_out = (ocall_enum1_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_errno_args_t* pargs_in = (ocall_errno_args_t*)input_buffer;
    ocall_errno_args_t* pargs_out = (ocall_errno_args_t*)output_buffer;
...
void ocall_ocall_set_host_errno(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_set_host_errno_args_t* pargs_in = (ocall_set_host_errno_args_t*)input_buffer;
    ocall_set_host_errno_args_t* pargs_out = (ocall_set_host_errno_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_noop_args_t* pargs_in = (ocall_noop_args_t*)input_buffer;
    ocall_noop_args_t* pargs_out = (ocall_noop_args_t*)output_buffer;
...
void ocall_ocall_foreign_ptr_1(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_ptr_1_args_t* pargs_in = (ocall_foreign_ptr_1_args_t*)input_buffer;
    ocall_foreign_ptr_1_args_t* pargs_out = (ocall_foreign_ptr_1_args_t*)output_buffer;
...
void ocall_ocall_foreign_ptr_2(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_ptr_2_args_t* pargs_in = (ocall_foreign_ptr_2_args_t*)input_buffer;
    ocall_foreign_ptr_2_args_t* pargs_out = (ocall_foreign_ptr_2_args_t*)output_buffer;
...
void ocall_ocall_foreign_ptr_3(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_ptr_3_args_t* pargs_in = (ocall_foreign_ptr_3_args_t*)input_buffer;
    ocall_foreign_ptr_3_args_t* pargs_out = (ocall_foreign_ptr_3_args_t*)output_buffer;
...
void ocall_ocall_foreign_ptr_4(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_ptr_4_args_t* pargs_in = (ocall_foreign_ptr_4_args_t*)input_buffer;
    ocall_foreign_ptr_4_args_t* pargs_out = (ocall_foreign_ptr_4_args_t*)output_buffer;
...
void ocall_ocall_foreign_ptr_5(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_ptr_5_args_t* pargs_in = (ocall_foreign_ptr_5_args_t*)input_buffer;
    ocall_foreign_ptr_5_args_t* pargs_out = (ocall_foreign_ptr_5_args_t*)output_buffer;
...
void ocall_ocall_foreign_isptr_1(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_isptr_1_args_t* pargs_in = (ocall_foreign_isptr_1_args_t*)input_buffer;
    ocall_foreign_isptr_1_args_t* pargs_out = (ocall_foreign_isptr_1_args_t*)output_buffer;
...
void ocall_ocall_foreign_isptr_2(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_isptr_2_args_t* pargs_in = (ocall_foreign_isptr_2_args_t*)input_buffer;
    ocall_foreign_isptr_2_args_t* pargs_out = (ocall_foreign_isptr_2_args_t*)output_buffer;
...
void ocall_ocall_foreign_isptr_3(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_isptr_3_args_t* pargs_in = (ocall_foreign_isptr_3_args_t*)input_buffer;
    ocall_foreign_isptr_3_args_t* pargs_out = (ocall_foreign_isptr_3_args_t*)output_buffer;
...
void ocall_ocall_foreign_isptr_4(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_isptr_4_args_t* pargs_in = (ocall_foreign_isptr_4_args_t*)input_buffer;
    ocall_foreign_isptr_4_args_t* pargs_out = (ocall_foreign_isptr_4_args_t*)output_buffer;
...
void ocall_ocall_foreign_isptr_5(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_isptr_5_args_t* pargs_in = (ocall_foreign_isptr_5_args_t*)input_buffer;
    ocall_foreign_isptr_5_args_t* pargs_out = (ocall_foreign_isptr_5_args_t*)output_buffer;
...
void ocall_ocall_foreign_isary(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_isary_args_t* pargs_in = (ocall_foreign_isary_args_t*)input_buffer;
    ocall_foreign_isary_args_t* pargs_out = (ocall_foreign_isary_args_t*)output_buffer;
...
void ocall_ocall_foreign_value(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_foreign_value_args_t* pargs_in = (ocall_foreign_value_args_t*)input_buffer;
    ocall_foreign_value_args_t* pargs_out = (ocall_foreign_value_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_foreign_value(
        pargs_in->a1);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_char_args_t* pargs_in = (ocall_pointer_char_args_t*)input_buffer;
    ocall_pointer_char_args_t* pargs_out = (ocall_pointer_char_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_char(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_wchar_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_wchar_t_args_t* pargs_in = (ocall_pointer_wchar_t_args_t*)input_buffer;
    ocall_pointer_wchar_t_args_t* pargs_out = (ocall_pointer_wchar_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_wchar_t(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_short(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_short_args_t* pargs_in = (ocall_pointer_short_args_t*)input_buffer;
    ocall_pointer_short_args_t* pargs_out = (ocall_pointer_short_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_short(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_int_args_t* pargs_in = (ocall_pointer_int_args_t*)input_buffer;
    ocall_pointer_int_args_t* pargs_out = (ocall_pointer_int_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_int(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_float(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_float_args_t* pargs_in = (ocall_pointer_float_args_t*)input_buffer;
    ocall_pointer_float_args_t* pargs_out = (ocall_pointer_float_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_float(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_double(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_double_args_t* pargs_in = (ocall_pointer_double_args_t*)input_buffer;
    ocall_pointer_double_args_t* pargs_out = (ocall_pointer_double_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_double(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_long_args_t* pargs_in = (ocall_pointer_long_args_t*)input_buffer;
    ocall_pointer_long_args_t* pargs_out = (ocall_pointer_long_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_long(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_size_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_size_t_args_t* pargs_in = (ocall_pointer_size_t_args_t*)input_buffer;
    ocall_pointer_size_t_args_t* pargs_out = (ocall_pointer_size_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_size_t(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_unsigned(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_unsigned_args_t* pargs_in = (ocall_pointer_unsigned_args_t*)input_buffer;
    ocall_pointer_unsigned_args_t* pargs_out = (ocall_pointer_unsigned_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_unsigned(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_int8_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_int8_t_args_t* pargs_in = (ocall_pointer_int8_t_args_t*)input_buffer;
    ocall_pointer_int8_t_args_t* pargs_out = (ocall_pointer_int8_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_int8_t(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_int16_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_int16_t_args_t* pargs_in = (ocall_pointer_int16_t_args_t*)input_buffer;
    ocall_pointer_int16_t_args_t* pargs_out = (ocall_pointer_int16_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_int16_t(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_int32_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_int32_t_args_t* pargs_in = (ocall_pointer_int32_t_args_t*)input_buffer;
    ocall_pointer_int32_t_args_t* pargs_out = (ocall_pointer_int32_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_int32_t(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_int64_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_int64_t_args_t* pargs_in = (ocall_pointer_int64_t_args_t*)input_buffer;
    ocall_pointer_int64_t_args_t* pargs_out = (ocall_pointer_int64_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_int64_t(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_uint8_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_uint8_t_args_t* pargs_in = (ocall_pointer_uint8_t_args_t*)input_buffer;
    ocall_pointer_uint8_t_args_t* pargs_out = (ocall_pointer_uint8_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_uint8_t(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_uint16_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_uint16_t_args_t* pargs_in = (ocall_pointer_uint16_t_args_t*)input_buffer;
    ocall_pointer_uint16_t_args_t* pargs_out = (ocall_pointer_uint16_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_uint16_t(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_uint32_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_uint32_t_args_t* pargs_in = (ocall_pointer_uint32_t_args_t*)input_buffer;
    ocall_pointer_uint32_t_args_t* pargs_out = (ocall_pointer_uint32_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_uint32_t(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_uint64_t(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_uint64_t_args_t* pargs_in = (ocall_pointer_uint64_t_args_t*)input_buffer;
    ocall_pointer_uint64_t_args_t* pargs_out = (ocall_pointer_uint64_t_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_uint64_t(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_long_long(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_long_long_args_t* pargs_in = (ocall_pointer_long_long_args_t*)input_buffer;
    ocall_pointer_long_long_args_t* pargs_out = (ocall_pointer_long_long_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_long_long(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_unsigned_char(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_unsigned_char_args_t* pargs_in = (ocall_pointer_unsigned_char_args_t*)input_buffer;
    ocall_pointer_unsigned_char_args_t* pargs_out = (ocall_pointer_unsigned_char_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_unsigned_char(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_unsigned_short(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_unsigned_short_args_t* pargs_in = (ocall_pointer_unsigned_short_args_t*)input_buffer;
    ocall_pointer_unsigned_short_args_t* pargs_out = (ocall_pointer_unsigned_short_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_unsigned_short(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_unsigned_int(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_unsigned_int_args_t* pargs_in = (ocall_pointer_unsigned_int_args_t*)input_buffer;
    ocall_pointer_unsigned_int_args_t* pargs_out = (ocall_pointer_unsigned_int_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_unsigned_int(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_unsigned_long(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_unsigned_long_args_t* pargs_in = (ocall_pointer_unsigned_long_args_t*)input_buffer;
    ocall_pointer_unsigned_long_args_t* pargs_out = (ocall_pointer_unsigned_long_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_unsigned_long(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_unsigned_long_long(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_unsigned_long_long_args_t* pargs_in = (ocall_pointer_unsigned_long_long_args_t*)input_buffer;
    ocall_pointer_unsigned_long_long_args_t* pargs_out = (ocall_pointer_unsigned_long_long_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_unsigned_long_long(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_pointer_long_double(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_long_double_args_t* pargs_in = (ocall_pointer_long_double_args_t*)input_buffer;
    ocall_pointer_long_double_args_t* pargs_out = (ocall_pointer_long_double_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_pointer_long_double(
        pargs_in->p1,
        pargs_in->p2,
        pargs_in->p3,
        pargs_in->p4,
...
void ocall_ocall_count_attribute_all_types(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_count_attribute_all_types_args_t* pargs_in = (ocall_count_attribute_all_types_args_t*)input_buffer;
    ocall_count_attribute_all_types_args_t* pargs_out = (ocall_count_attribute_all_types_args_t*)output_buffer;
    ...
    /* Call user function. */
    ocall_count_attribute_all_types(
        pargs_in->b1,
        pargs_in->b2,
        pargs_in->b3,
        pargs_in->b4,
...
void ocall_ocall_size_attribute_all_types(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_size_attribute_all_types_args_t* pargs_in = (ocall_size_attribute_all_types_args_t*)input_buffer;
    ocall_size_attribute_all_types_args_t* pargs_out = (ocall_size_attribute_all_types_args_t*)output_buffer;
    ...
    /* Call user function. */
    ocall_size_attribute_all_types(
        pargs_in->b1,
        pargs_in->b2,
        pargs_in->b3,
        pargs_in->b4,
...
void ocall_ocall_pointer_assert_all_called(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_pointer_assert_all_called_args_t* pargs_in = (ocall_pointer_assert_all_called_args_t*)input_buffer;
    ocall_pointer_assert_all_called_args_t* pargs_out = (ocall_pointer_assert_all_called_args_t*)output_buffer;
    ...
    /* Call user function. */
    ocall_pointer_assert_all_called(
    );
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_string_fun1_args_t* pargs_in = (ocall_string_fun1_args_t*)input_buffer;
    ocall_string_fun1_args_t* pargs_out = (ocall_string_fun1_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_string_fun2_args_t* pargs_in = (ocall_string_fun2_args_t*)input_buffer;
    ocall_string_fun2_args_t* pargs_out = (ocall_string_fun2_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_string_fun3_args_t* pargs_in = (ocall_string_fun3_args_t*)input_buffer;
    ocall_string_fun3_args_t* pargs_out = (ocall_string_fun3_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_string_fun5_args_t* pargs_in = (ocall_string_fun5_args_t*)input_buffer;
    ocall_string_fun5_args_t* pargs_out = (ocall_string_fun5_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_string_fun6_args_t* pargs_in = (ocall_string_fun6_args_t*)input_buffer;
    ocall_string_fun6_args_t* pargs_out = (ocall_string_fun6_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_string_fun7_args_t* pargs_in = (ocall_string_fun7_args_t*)input_buffer;
    ocall_string_fun7_args_t* pargs_out = (ocall_string_fun7_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_wstring_fun1_args_t* pargs_in = (ocall_wstring_fun1_args_t*)input_buffer;
    ocall_wstring_fun1_args_t* pargs_out = (ocall_wstring_fun1_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_wstring_fun2_args_t* pargs_in = (ocall_wstring_fun2_args_t*)input_buffer;
    ocall_wstring_fun2_args_t* pargs_out = (ocall_wstring_fun2_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_wstring_fun3_args_t* pargs_in = (ocall_wstring_fun3_args_t*)input_buffer;
    ocall_wstring_fun3_args_t* pargs_out = (ocall_wstring_fun3_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_wstring_fun5_args_t* pargs_in = (ocall_wstring_fun5_args_t*)input_buffer;
    ocall_wstring_fun5_args_t* pargs_out = (ocall_wstring_fun5_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_wstring_fun6_args_t* pargs_in = (ocall_wstring_fun6_args_t*)input_buffer;
    ocall_wstring_fun6_args_t* pargs_out = (ocall_wstring_fun6_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_wstring_fun7_args_t* pargs_in = (ocall_wstring_fun7_args_t*)input_buffer;
    ocall_wstring_fun7_args_t* pargs_out = (ocall_wstring_fun7_args_t*)output_buffer;
...
void ocall_ocall_string_no_null_terminator(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_string_no_null_terminator_args_t* pargs_in = (ocall_string_no_null_terminator_args_t*)input_buffer;
    ocall_string_no_null_terminator_args_t* pargs_out = (ocall_string_no_null_terminator_args_t*)output_buffer;
    ...
    /* Call user function. */
    ocall_string_no_null_terminator(
        pargs_in->erasenull,
        pargs_in->s);
...
void ocall_ocall_wstring_no_null_terminator(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_wstring_no_null_terminator_args_t* pargs_in = (ocall_wstring_no_null_terminator_args_t*)input_buffer;
    ocall_wstring_no_null_terminator_args_t* pargs_out = (ocall_wstring_no_null_terminator_args_t*)output_buffer;
    ...
    /* Call user function. */
    ocall_wstring_no_null_terminator(
        pargs_in->erasenull,
        pargs_in->s);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_struct1_args_t* pargs_in = (ocall_struct1_args_t*)input_buffer;
    ocall_struct1_args_t* pargs_out = (ocall_struct1_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = ocall_struct1(
        pargs_in->a1,
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ocall_sum_args_t* pargs_in = (ocall_sum_args_t*)input_buffer;
    ocall_sum_args_t* pargs_out = (ocall_sum_args_t*)output_buffer;
...
void ocall_switchless_ocall_sum(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    switchless_ocall_sum_args_t* pargs_in = (switchless_ocall_sum_args_t*)input_buffer;
    switchless_ocall_sum_args_t* pargs_out = (switchless_ocall_sum_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = switchless_ocall_sum(
        pargs_in->a,
        pargs_in->b);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    host_foo1_args_t* pargs_in = (host_foo1_args_t*)input_buffer;
    host_foo1_args_t* pargs_out = (host_foo1_args_t*)output_buffer;
...
static oe_ocall_func_t __all_ocall_function_table[] = {
    (oe_ocall_func_t) ocall_ocall_array_char,
    (oe_ocall_func_t) ocall_ocall_array_wchar_t,
    (oe_ocall_func_t) ocall_ocall_array_short,
    (oe_ocall_func_t) ocall_ocall_array_int,
    (oe_ocall_func_t) ocall_ocall_array_float,
    (oe_ocall_func_t) ocall_ocall_array_double,
    (oe_ocall_func_t) ocall_ocall_array_long,
    (oe_ocall_func_t) ocall_ocall_array_size_t,
    (oe_ocall_func_t) ocall_ocall_array_unsigned,
    (oe_ocall_func_t) ocall_ocall_array_int8_t,
    (oe_ocall_func_t) ocall_ocall_array_int16_t,
    (oe_ocall_func_t) ocall_ocall_array_int32_t,
    (oe_ocall_func_t) ocall_ocall_array_int64_t,
    (oe_ocall_func_t) ocall_ocall_array_uint8_t,
    (oe_ocall_func_t) ocall_ocall_array_uint16_t,
    (oe_ocall_func_t) ocall_ocall_array_uint32_t,
    (oe_ocall_func_t) ocall_ocall_array_uint64_t,
    (oe_ocall_func_t) ocall_ocall_array_long_long,
    (oe_ocall_func_t) ocall_ocall_array_unsigned_char,
    (oe_ocall_func_t) ocall_ocall_array_unsigned_short,
    (oe_ocall_func_t) ocall_ocall_array_unsigned_int,
    (oe_ocall_func_t) ocall_ocall_array_unsigned_long,
    (oe_ocall_func_t) ocall_ocall_array_unsigned_long_long,
    (oe_ocall_func_t) ocall_ocall_array_long_double,
    (oe_ocall_func_t) ocall_ocall_array_assert_all_called,
    (oe_ocall_func_t) ocall_ocall_basic_types,
    (oe_ocall_func_t) ocall_ocall_basic_non_portable_types,
    (oe_ocall_func_t) ocall_get_host_sizeof,
    (oe_ocall_func_t) ocall_ocall_ret_char,
    (oe_ocall_func_t) ocall_ocall_ret_wchar_t,
    (oe_ocall_func_t) ocall_ocall_ret_short,
    (oe_ocall_func_t) ocall_ocall_ret_int,
    (oe_ocall_func_t) ocall_ocall_ret_float,
    (oe_ocall_func_t) ocall_ocall_ret_double,
    (oe_ocall_func_t) ocall_ocall_ret_long,
    (oe_ocall_func_t) ocall_ocall_ret_size_t,
    (oe_ocall_func_t) ocall_ocall_ret_unsigned,
    (oe_ocall_func_t) ocall_ocall_ret_int8_t,
    (oe_ocall_func_t) ocall_ocall_ret_int16_t,
    (oe_ocall_func_t) ocall_ocall_ret_int32_t,
    (oe_ocall_func_t) ocall_ocall_ret_int64_t,
    (oe_ocall_func_t) ocall_ocall_ret_uint8_t,
    (oe_ocall_func_t) ocall_ocall_ret_uint16_t,
    (oe_ocall_func_t) ocall_ocall_ret_uint32_t,
    (oe_ocall_func_t) ocall_ocall_ret_uint64_t,
    (oe_ocall_func_t) ocall_ocall_ret_long_long,
    (oe_ocall_func_t) ocall_ocall_ret_unsigned_char,
    (oe_ocall_func_t) ocall_ocall_ret_unsigned_short,
    (oe_ocall_func_t) ocall_ocall_ret_unsigned_int,
    (oe_ocall_func_t) ocall_ocall_ret_unsigned_long,
    (oe_ocall_func_t) ocall_ocall_ret_long_double,
    (oe_ocall_func_t) ocall_ocall_ret_unsigned_long_long,
    (oe_ocall_func_t) ocall_ocall_ret_void,
    (oe_ocall_func_t) ocall_ocall_enum1,
    (oe_ocall_func_t) ocall_ocall_errno,
    (oe_ocall_func_t) ocall_ocall_set_host_errno,
    (oe_ocall_func_t) ocall_ocall_noop,
    (oe_ocall_func_t) ocall_ocall_foreign_ptr_1,
    (oe_ocall_func_t) ocall_ocall_foreign_ptr_2,
    (oe_ocall_func_t) ocall_ocall_foreign_ptr_3,
    (oe_ocall_func_t) ocall_ocall_foreign_ptr_4,
    (oe_ocall_func_t) ocall_ocall_foreign_ptr_5,
    (oe_ocall_func_t) ocall_ocall_foreign_isptr_1,
    (oe_ocall_func_t) ocall_ocall_foreign_isptr_2,
    (oe_ocall_func_t) ocall_ocall_foreign_isptr_3,
    (oe_ocall_func_t) ocall_ocall_foreign_isptr_4,
    (oe_ocall_func_t) ocall_ocall_foreign_isptr_5,
    (oe_ocall_func_t) ocall_ocall_foreign_isary,
    (oe_ocall_func_t) ocall_ocall_foreign_value,
    (oe_ocall_func_t) ocall_ocall_pointer_char,
    (oe_ocall_func_t) ocall_ocall_pointer_wchar_t,
    (oe_ocall_func_t) ocall_ocall_pointer_short,
    (oe_ocall_func_t) ocall_ocall_pointer_int,
    (oe_ocall_func_t) ocall_ocall_pointer_float,
    (oe_ocall_func_t) ocall_ocall_pointer_double,
    (oe_ocall_func_t) ocall_ocall_pointer_long,
    (oe_ocall_func_t) ocall_ocall_pointer_size_t,
    (oe_ocall_func_t) ocall_ocall_pointer_unsigned,
    (oe_ocall_func_t) ocall_ocall_pointer_int8_t,
    (oe_ocall_func_t) ocall_ocall_pointer_int16_t,
    (oe_ocall_func_t) ocall_ocall_pointer_int32_t,
    (oe_ocall_func_t) ocall_ocall_pointer_int64_t,
    (oe_ocall_func_t) ocall_ocall_pointer_uint8_t,
    (oe_ocall_func_t) ocall_ocall_pointer_uint16_t,
    (oe_ocall_func_t) ocall_ocall_pointer_uint32_t,
    (oe_ocall_func_t) ocall_ocall_pointer_uint64_t,
    (oe_ocall_func_t) ocall_ocall_pointer_long_long,
    (oe_ocall_func_t) ocall_ocall_pointer_unsigned_char,
    (oe_ocall_func_t) ocall_ocall_pointer_unsigned_short,
    (oe_ocall_func_t) ocall_ocall_pointer_unsigned_int,
    (oe_ocall_func_t) ocall_ocall_pointer_unsigned_long,
    (oe_ocall_func_t) ocall_ocall_pointer_unsigned_long_long,
    (oe_ocall_func_t) ocall_ocall_pointer_long_double,
    (oe_ocall_func_t) ocall_ocall_count_attribute_all_types,
    (oe_ocall_func_t) ocall_ocall_size_attribute_all_types,
    (oe_ocall_func_t) ocall_ocall_pointer_assert_all_called,
    (oe_ocall_func_t) ocall_ocall_string_fun1,
    (oe_ocall_func_t) ocall_ocall_string_fun2,
    (oe_ocall_func_t) ocall_ocall_string_fun3,
    (oe_ocall_func_t) ocall_ocall_string_fun5,
    (oe_ocall_func_t) ocall_ocall_string_fun6,
    (oe_ocall_func_t) ocall_ocall_string_fun7,
    (oe_ocall_func_t) ocall_ocall_wstring_fun1,
    (oe_ocall_func_t) ocall_ocall_wstring_fun2,
    (oe_ocall_func_t) ocall_ocall_wstring_fun3,
    (oe_ocall_func_t) ocall_ocall_wstring_fun5,
    (oe_ocall_func_t) ocall_ocall_wstring_fun6,
    (oe_ocall_func_t) ocall_ocall_wstring_fun7,
    (oe_ocall_func_t) ocall_ocall_string_no_null_terminator,
    (oe_ocall_func_t) ocall_ocall_wstring_no_null_terminator,
    (oe_ocall_func_t) ocall_ocall_struct1,
    (oe_ocall_func_t) ocall_ocall_sum,
    (oe_ocall_func_t) ocall_switchless_ocall_sum,
    (oe_ocall_func_t) ocall_host_foo1,
    NULL
};
