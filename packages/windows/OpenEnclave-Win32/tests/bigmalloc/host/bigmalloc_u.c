    ...
    oe_result_t* _retval)
{
    ...
    /* Marshalling struct. */
    test_malloc_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_malloc_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_malloc_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (test_malloc_args_t*)_input_buffer;
    ...
    _pargs_out = (test_malloc_args_t*)_output_buffer;
...
static oe_ocall_func_t __bigmalloc_ocall_function_table[] = {
    
    NULL
};

oe_result_t oe_create_bigmalloc_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               config_size,
#endif
               __bigmalloc_ocall_function_table,
               0,
               enclave);
}
