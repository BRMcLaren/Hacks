    ...
    size_t hexstr_length)
{
    ...
    _args.data_length = data_length;
    _args.hexstr = (char*)hexstr;
    _args.hexstr_length = hexstr_length;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_args_t));
    if (data)
        OE_ADD_SIZE(_input_buffer_size, (_args.data_length * sizeof(unsigned char)));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_args_t));
    if (hexstr)
        OE_ADD_SIZE(_output_buffer_size, (_args.hexstr_length * sizeof(char)));
    ...
    if (data)
        OE_WRITE_IN_PARAM(data, (_args.data_length * sizeof(unsigned char)), unsigned char*);
    ...
    *_retval = _pargs_out->_retval;
    ...
    OE_READ_OUT_PARAM(hexstr, (size_t)((_args.hexstr_length * sizeof(char))));
...
static oe_ocall_func_t __hexdump_ocall_function_table[] = {
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               config_size,
#endif
               __hexdump_ocall_function_table,
               0,
               enclave);
}
