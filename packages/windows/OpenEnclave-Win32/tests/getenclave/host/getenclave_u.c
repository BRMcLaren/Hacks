    ...
    oe_enclave_t* enclaveParam)
{
    ...
    /* Marshalling struct. */
    test_get_enclave_ecall_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.enclaveParam = (oe_enclave_t*)enclaveParam;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_get_enclave_ecall_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_get_enclave_ecall_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (test_get_enclave_ecall_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             getenclave_fcn_id_test_get_enclave_ecall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (test_get_enclave_ecall_args_t*)_output_buffer;
...
void ocall_test_get_enclave_ocall(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    test_get_enclave_ocall_args_t* pargs_in = (test_get_enclave_ocall_args_t*)input_buffer;
    test_get_enclave_ocall_args_t* pargs_out = (test_get_enclave_ocall_args_t*)output_buffer;
...
static oe_ocall_func_t __getenclave_ocall_function_table[] = {
    (oe_ocall_func_t) ocall_test_get_enclave_ocall,
    NULL
};
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               config_size,
#endif
               __getenclave_ocall_function_table,
               1,
               enclave);
}
