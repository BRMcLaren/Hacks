 ...
 */
#ifndef EDGER8R_SAMPLEAPPCRT_ARGS_H
#define EDGER8R_SAMPLEAPPCRT_ARGS_H
...
enum
{
    SampleAppCRT_fcn_id_enc_test = 0,
    SampleAppCRT_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};
...
enum
{
    ...
    SampleAppCRT_fcn_id_untrusted_call_max = OE_ENUM_MAX
};

#endif // EDGER8R_SAMPLEAPPCRT_ARGS_H
