    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    f_open_args_t* pargs_in = (f_open_args_t*)input_buffer;
    f_open_args_t* pargs_out = (f_open_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    f_openat_args_t* pargs_in = (f_openat_args_t*)input_buffer;
    f_openat_args_t* pargs_out = (f_openat_args_t*)output_buffer;
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    f_read_args_t* pargs_in = (f_read_args_t*)input_buffer;
    f_read_args_t* pargs_out = (f_read_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (pargs_in->ptr)
        OE_SET_IN_OUT_POINTER(ptr, pargs_in->len, char*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (pargs_in->ptr)
        OE_COPY_AND_SET_IN_OUT_POINTER(ptr, pargs_in->len, char*);

    /* Call user function. */
    pargs_out->_retval = f_read(
        pargs_in->fd,
        pargs_in->ptr,
        pargs_in->len);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    f_close_args_t* pargs_in = (f_close_args_t*)input_buffer;
    f_close_args_t* pargs_out = (f_close_args_t*)output_buffer;
...
static oe_ocall_func_t __crypto_ocall_function_table[] = {
    (oe_ocall_func_t) ocall_f_open,
    (oe_ocall_func_t) ocall_f_openat,
    (oe_ocall_func_t) ocall_f_read,
    (oe_ocall_func_t) ocall_f_close,
    NULL
};
