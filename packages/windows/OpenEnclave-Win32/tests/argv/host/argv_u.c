...
oe_result_t test_argv_ecall(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    test_argv_ecall_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(test_argv_ecall_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(test_argv_ecall_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (test_argv_ecall_args_t*)_input_buffer;
    ...
    _pargs_out = (test_argv_ecall_args_t*)_output_buffer;
...
static oe_ocall_func_t __argv_ocall_function_table[] = {
