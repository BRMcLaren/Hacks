 ...
 */
#ifndef EDGER8R_STDCXX_ARGS_H
#define EDGER8R_STDCXX_ARGS_H
...
enum
{
    stdcxx_fcn_id_enc_test = 0,
    stdcxx_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};
...
enum
{
    ...
    stdcxx_fcn_id_untrusted_call_max = OE_ENUM_MAX
};

#endif // EDGER8R_STDCXX_ARGS_H
