...
static oe_ocall_func_t __debug_mode_ocall_function_table[] = {
    
    NULL
};

oe_result_t oe_create_debug_mode_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               config_size,
#endif
               __debug_mode_ocall_function_table,
               0,
               enclave);
}
