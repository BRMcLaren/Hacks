 ...
 */
#ifndef EDGER8R_DEBUG_MODE_ARGS_H
#define EDGER8R_DEBUG_MODE_ARGS_H
...
enum
{
    debug_mode_fcn_id_test = 0,
    debug_mode_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};
...
enum
{
    ...
    debug_mode_fcn_id_untrusted_call_max = OE_ENUM_MAX
};

#endif // EDGER8R_DEBUG_MODE_ARGS_H
