    ...
    int* ret)
{
    ...
    /* Marshalling struct. */
    enc_props_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(enc_props_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enc_props_args_t));
    if (ret)
    ...
    _pargs_in = (enc_props_args_t*)_input_buffer;
    ...
    _pargs_out = (enc_props_args_t*)_output_buffer;
    ...
    *_retval = _pargs_out->_retval;
    ...
    OE_READ_OUT_PARAM(ret, (size_t)(sizeof(int)));
...
static oe_ocall_func_t __props_ocall_function_table[] = {
    
    NULL
};

oe_result_t oe_create_props_enclave(
    const char* path,
