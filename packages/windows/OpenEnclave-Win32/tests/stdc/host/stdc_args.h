 ...
 */
#ifndef EDGER8R_STDC_ARGS_H
#define EDGER8R_STDC_ARGS_H
...
{
    stdc_fcn_id_test = 0,
    stdc_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};
...
enum
{
    ...
    stdc_fcn_id_untrusted_call_max = OE_ENUM_MAX
};

#endif // EDGER8R_STDC_ARGS_H
