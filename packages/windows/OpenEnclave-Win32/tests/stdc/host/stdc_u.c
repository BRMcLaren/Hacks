    ...
    char buf2[1024])
{
    ...
    _args.buf1 = (char*)buf1;
    _args.buf2 = (char*)buf2;
    ...
    if (buf1)
        OE_ADD_SIZE(_output_buffer_size, sizeof(char[1024]));
    if (buf2)
        OE_ADD_SIZE(_output_buffer_size, sizeof(char[1024]));
    ...
    *_retval = _pargs_out->_retval;
    ...
    OE_READ_OUT_PARAM(buf1, (size_t)(sizeof(char[1024])));
    OE_READ_OUT_PARAM(buf2, (size_t)(sizeof(char[1024])));
...
static oe_ocall_func_t __stdc_ocall_function_table[] = {
